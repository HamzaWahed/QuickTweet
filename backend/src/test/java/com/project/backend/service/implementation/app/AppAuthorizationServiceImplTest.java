...
@Transactional
public class AppAuthorizationServiceImplTest ***REMOVED***
  @Autowired
  ...
  @Test
  void testGetPendingRequests() ***REMOVED***
    AppUser admin =
  ...
  ***REMOVED***
  ...
  @Test
  void testApprovePendingRequest() ***REMOVED***
    AppUser user =
        new AppUser("testUser", "testUser@dal.ca", "password", "USER", "Question?", "Answer");
  ...
  ***REMOVED***
  ...
  @Test
  void testApprovePendingRequestWithInvalidUser() ***REMOVED***
    AppAuthorization app = new AppAuthorization();
    app.setId(1L);
    appAuthorizationRepository.save(app);
    assertThat(service.approvePendingRequest("testUser"))
  ...
  ***REMOVED***
  ...
  @Test
  void testRejectPendingRequest() ***REMOVED***
    AppUser user =
        new AppUser("testUser", "testUser@dal.ca", "password", "USER", "Question?", "Answer");
  ...
  ***REMOVED***
  ...
  @Test
  void testRejectPendingRequestWithInvalidUser() ***REMOVED***
    AppAuthorization app = new AppAuthorization();
    app.setId(1L);
    appAuthorizationRepository.save(app);
    assertThat(service.rejectPendingRequest("testUser"))

...
public class AppAuthorizationControllerTest ***REMOVED***
  ...
  ***REMOVED***
  ...
  @Test
  @WithMockUser
  void testGetPendingRequests() throws Exception ***REMOVED***
  ...
  ***REMOVED***
  ...
  @Test
  @WithMockUser
  void testGetPendingRequestsNoRequests() throws Exception ***REMOVED***
    Set<AppUser> pendingRequests = new HashSet<>();
  ...
  ***REMOVED***
  ...
  @Test
  @WithMockUser
  void testApprovePendingRequestSuccess() throws Exception ***REMOVED***
  ...
  ***REMOVED***
  ...
  @Test
  @WithMockUser
  void testApprovePendingRequestFailure() throws Exception ***REMOVED***
  ...
  ***REMOVED***
  ...
  @Test
  @WithMockUser
  public void testRejectPendingRequestSuccess() throws Exception ***REMOVED***
  ...
  ***REMOVED***
  ...
  @Test
  @WithMockUser
  public void testRejectPendingRequestFailure() throws Exception ***REMOVED***
    String responseMessage = "User does not exist.";

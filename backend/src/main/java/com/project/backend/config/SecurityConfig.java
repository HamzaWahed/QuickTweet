...
@Configuration
@EnableWebSecurity
public class SecurityConfig implements SecurityConfigInterface ***REMOVED***
  private final UserDetailsServiceImpl userDetailsService;
  private final AuthenticationFilter authenticationFilter;
  private final AuthEntryPoint exceptionHandler;

  public SecurityConfig(UserDetailsServiceImpl userDetailsServiceImpl,
      AuthenticationFilter authenticationFilter, AuthEntryPoint exceptionHandler) ***REMOVED***
  ...
  ***REMOVED***
   ...
   * @throws Exception
   */
  public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
  @Bean
  public PasswordEncoder passwordEncoder() ***REMOVED***
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception ***REMOVED***
    http.csrf((csrf) -> csrf.disable()).cors(withDefaults())
        ...
        .authorizeHttpRequests((authorizeHttpRequests) -> authorizeHttpRequests
            ...
            .requestMatchers(HttpMethod.GET, "/users/forgotPassword/***REMOVED***username***REMOVED***").permitAll()
            .requestMatchers(HttpMethod.POST, "/users/forgotPassword/***REMOVED***username***REMOVED***").permitAll()

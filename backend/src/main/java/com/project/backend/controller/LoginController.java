...
@RestController
public class LoginController ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
  @PostMapping("/login")
  public ResponseEntity<?> getToken(@RequestBody AccountCredentials credentials) throws Exception ***REMOVED***
    AppUser user = userRepository.findByUsername(credentials.username())
        .orElseThrow(() -> new UsernameNotFoundException("User does not exist"));

    if (user.isPendingRequest()) ***REMOVED***
